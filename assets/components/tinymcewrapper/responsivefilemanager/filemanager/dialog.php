<?php
////////////MODX initialize MODx - grab user's config file////////////////////
...
////////////////////////////////////////////////////////////////////////
//grab custom propertyset from url
$getParam = (isset($_GET['pset']) && $_GET['pset'] != '' ? $_GET['pset'] : '');
$_SESSION["pset"] = $getParam; //pass this value to config/config.php so that any file including it will get the correct PropertySet properties
//by default this getParam will be lost when RFM rebuilds the url as a folder or refresh is hit.
//proceed to add this to RFM's $get_params = array(...)
////////////END MODX initialize//////////////////////////////////////////////
...
$get_params = array(
  'pset'   => (isset($_GET['pset']) && $_GET['pset'] != '' ? $_GET['pset'] : ''), // MODX custom PropertySet
  'editor'    => $editor,
  'type'      => $type_param,
  'lang'      => $lang,
  'popup'     => $popup,
